...
def test_trim():
    dft = dfts.Dft()
    be_a = dft_be.BeExponential(0, "A", 5.0, 1, 0, (0, 0))
    dft.add(be_a)
    be_b = dft_be.BeExponential(1, "B", 3.0, 1, 0, (2, 2))
    dft.add(be_b)
    be_c = dft_be.BeExponential(2, "C", 1.0, 1, 0, (2, 2))
    dft.add(be_c)
    and_t = dft_gates.DftAnd(3, "T", [be_a, be_b], (10, 10))
    dft.add(and_t)
