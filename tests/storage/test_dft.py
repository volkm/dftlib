...
def test_create_dft():
    ...
    be_a = dft_be.BeExponential(dft.next_id(), "A", 5.0, 1, 0, (0, 0))
    dft.add(be_a)
    be_b = dft_be.BeExponential(dft.next_id(), "B", 3.0, 1, 0, (2, 2))
    dft.add(be_b)
    and_t = dft_gates.DftAnd(dft.next_id(), "T", [be_a, be_b], (10, 10))
    dft.add(and_t)
